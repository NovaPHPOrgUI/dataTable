!(function (e, t) {
  ...
  return (() => {
    var e = {
        ...
        125: (e) => {
          e.exports =
            '<th {{vm.thAttr}}><div class="th-wrap"><span class="{{vm.thTextClassName}}" {{vm.compileAttr}}>{{vm.thText}}</span>\t\t{{vm.remindHtml}}\t\t{{vm.sortHtml}}\t\t{{vm.filterHtml}}\t\t{{vm.adjustHtml}}</div></th>';
        },
        985: (e) => {
          e.exports =
        ...
        763: (e) => {
          e.exports =
            '<table class="dreamland-row {{vm.class}}"><tbody>{{vm.tbody}}</tbody></table>';
        },
        923: (e) => {
          e.exports =
        ...
        472: (e) => {
          e.exports =
            '<div class="gm-sorting-action{{vm.typeClass}}"><i class="sa-icon sa-up gm-icon gm-icon-up"></i><i class="sa-icon sa-down gm-icon gm-icon-down"></i></div>';
        },
      },
      t = {};
    function o(n) {
      ...
      (() => {
            ...
            if (
              ...
              (g(e.length) ||
                [].every.call(
                  e,
                  (e, o) => (
                    !i(e) && l(e) && (e = e.get(0)), !1 !== t.call(e, e, o)
                  ),
                ),
              x(e))
            )
          ...
          p = (t) => {
            ...
            if (1 === n.length) {
              const e = n[0],
                o = e.nodeName,
                s = e.childNodes;
              ((!/<tbody|<TBODY/.test(t) && "TBODY" === o) ||
                (!/<thead|<THEAD/.test(t) && "THEAD" === o) ||
                (!/<tr|<TR/.test(t) && "TR" === o) ||
                (!/<td|<TD/.test(t) && "TD" === o) ||
                (!/<th|<TH/.test(t) && "TH" === o)) &&
                (n = s);
        ...
        function S(...[]) {
          ...
          let e,
            ...
            n = arguments[0];
          for (
            1 === arguments.length && x(arguments[0])
              ? ((n = this), (o = 0))
              : 2 === arguments.length && y(arguments[0])
                ? ((t = arguments[0]), (n = this), (o = 1))
                : arguments.length > 2 &&
                  y(arguments[0]) &&
                  ((t = arguments[0]), (n = arguments[1] || {}), (o = 2));
            o < arguments.length;
            o++
          )
            (e = arguments[o] || {}), s(e, n);
        ...
        function _(e) {
          ...
          "GET" === o &&
            ...
            "POST" === o &&
              ...
              0 === s[A].indexOf("application/json") &&
                (p = JSON.stringify(n))),
            h.open(o, t, r);
        ...
        const N = {
          css: function (e, t) {
            ...
            if (x(e)) for (const t in e) L(o, t, e[t]);
            else L(o, e, t);
            return this;
          },
          width: function (e) {
        ...
        const q = {
          ...
          I = {
            ...
            index: function (e) {
              const t = d(this, 0);
              return (
                e ? l(e) && (e = d(e)) : (e = t.parentNode.children),
        ...
        const Q = Y,
          ...
          Ke = "px",
          Be = (e) => [
            `background:${e};height:18px;line-height:18px;padding:1px;border-radius:3px 0 0 3px;color:#fff`,
            "background:#169fe6;height:18px;line-height:18px;padding:1px;border-radius:0 3px 3px 0;color:#fff",
          ],
          Fe = "Info",
          Ie = "Warn",
          Ge = "Error",
          We = { [Fe]: Be("#333"), [Ie]: Be("#f90"), [Ge]: Be("#f00") },
          Je = {
            [Z]: {},
            [te]: {},
            [ee]: {},
          ...
          it = "target",
          at = "selector",
          ct = (e, t, o) => ({ [rt]: e, [it]: t, [at]: o }),
          lt = (e, t, o) => {
            let n = S(!0, {}, t);
            for (let t in e) e[t].isAutoCreate && delete n[t];
            return (
              delete n.gm_checkbox_disabled,
              delete n[ue],
              delete n[le],
              delete n[he],
              delete n[me],
          ...
          yt = (e) => Ue(e, ae),
          xt = (e, t) => (
            t.jTool && (t = $t(t)), Q(`[${re}="${e}"] th[th-name="${t}"]`)
          ),
          wt = (e, t) =>
            Q(`[grid-manager-mock-thead="${e}"] th[th-name="${t}"]`),
          kt = (e) => Q(`[${re}="${e}"] th:not(cell-hidden)`),
          Ct = (e, t) =>
            Q(
              `[grid-manager-mock-thead="${e}"] th:not([cell-hidden])${t ? ":not([gm-create])" : ""}`,
            ),
          $t = (e) => e.attr(ce),
          Tt = (e) => Q(`[empty-template="${e}"]`),
          St = (e, t) =>
            m(t)
              ? Q(`tbody tr td:nth-child(${e.index() + 1})`, gt(t))
              : Q(`td:nth-child(${e.index() + 1})`, t),
          Dt = (e, t, o) => {
            u(k(t) ? t : [t], (t) => {
              const n = xt(e, t),
                s = wt(e, t),
          ...
          At = (e, t) => {
            ...
            if ((d && g > 0 && !h && (d.width = d.width + g), g > 0 && h)) {
              ...
              u(c, (t, o) => {
                o !== h - 1
                  ? ((t.width = t.width + e), (g -= e))
                  : (t.width = t.width + g);
              });
            }
            u(n, (e, t) => {
              (t.isShow && t.disableCustomize) ||
                t.pk ||
                xt(o, e).width(t.width);
            });
          },
          Mt = (e, t, o, n) => {
            const s = (e, t, o) => {
          ...
          _t = (e, t) => {
            ...
            if ((r.css("left", -s.scrollLeft() + Ke), !t)) {
              let e;
              for (let t in n)
                (e = n[t].width), wt(o, t).css({ width: e, "max-width": e });
              r.width(vt(o).width());
            }
          },
          Pt = (e) => {
          ...
          Ht = (e) => {
            ...
            (a.style.width = `calc(${o})`),
              ...
              (ft(t).get(0).style.height = i
                ? `calc(100% - ${Q(`[${ne}="${t}"]`).height() + Ke})`
                : "100%"),
          ...
          Kt = (e, t, o) => {
            ...
            return m(o)
              ? e[o] === t[o]
              : n.length === s.length &&
                  n.every((o) => JSON.stringify(e[o]) === JSON.stringify(t[o]));
          },
          Bt = (e) => JSON.parse(JSON.stringify(e)),
          Ft = {},
          It = { supportDrag: !0, dragBefore: c, dragAfter: c },
          Gt = { supportMoveRow: !1, moveRowConfig: { handler: c } },
          Wt = { supportAdjust: !0, adjustBefore: c, adjustAfter: c },
          Jt = { supportMenu: !0, menuHandler: (e) => e },
          Ut = { supportConfig: !0, configInfo: "配置列的显示状态" },
          Vt = {
            width: "100%",
            height: "300px",
            lineHeight: "41px",
          ...
          eo = { supportAutoOrder: !0, autoOrderConfig: { width: 50 } },
          to = {
            supportCheckbox: !0,
          ...
          no = {
            supportTreeData: !1,
            treeConfig: { treeKey: "children", openState: !1 },
          },
          so = {
            firstLoading: !0,
            ...
            dataKey: "data",
            emptyTemplate: () =>
              '<div class="gm-empty-template">暂无数据</div>',
          },
          ro = {
            supportExport: !0,
            exportConfig: { mode: "static", suffix: "xls", handler: c },
          },
          io = { supportPrint: !0 },
          ao = {
            supportAutoPlay: !1,
            autoPlayConfig: { interval: 5, step: 40 },
          };
        function co() {
          S(
            !0,
        ...
        function lo() {
          ...
          (e["order-text"] = {
            ...
            (e["page-info"] = {
              "zh-cn":
                '此页显示 {0}-{1}<span class="page-info-totals"> 共{2}条</span>',
              "zh-tw":
                '此頁顯示 {0}-{1}<span class="page-info-totals"> 共{2}條</span>',
              "en-us":
                'this page show {0}-{1}<span class="page-info-totals"> count {2}</span>',
            }),
            (e["checked-info"] = {
              "zh-cn": "已选 {0} 条",
              "zh-tw": "已選 {0} 條",
            ...
            (e.print = { "zh-cn": "打印", "zh-tw": "打印", "en-us": "Print" }),
            (e.copy = { "zh-cn": "复制", "zh-tw": "復制", "en-us": "Copy" }),
            (e["hide-row"] = {
              "zh-cn": "隐藏行",
              "zh-tw": "隱藏行",
              "en-us": "Hidden Row",
            }),
            (e.ok = { "zh-cn": "确定", "zh-tw": "確定", "en-us": "OK" }),
        ...
        const uo = {
              ...
              a &&
                (s = ((e, t, o) => {
                  let n = -1,
                    s = !1;
                  return (
                    e.some((e, r) => ((s = Kt(e, t, o)), s && (n = r), s)), n
                  );
                })(r, t, i)),
          ...
          $o = (e) => {
            let t = go(ve);
            return t && "{}" !== t
              ? ((t = JSON.parse(t)), JSON.parse(t[Co(e)] || "{}"))
              : (gt(e).attr(ye, "error"), {});
          },
          To = (e) => {
            const {
          ...
          Do = (e) => {
            ...
            const n = (e) => {
              e.forEach((e) => {
                const t = e.text;
                if ((t && !v(t) && (e.text = () => t), C(e.children)))
                  return n(e.children), void delete e.template;
                const o = e.template;
                o && !v(o) && (e.template = () => o);
              });
            };
          ...
          jo = (e) => (m(e[0]) ? e.map((e) => ({ key: e, text: e })) : e),
          Ao = (e, t, o, n, s) => {
            const {
                __isNested: r,
                columnData: i,
              ...
              v = {};
            i.some((e) => "left" === e.fixed) &&
              ((c.fixed = "left"), (f.fixed = "left"), (d.fixed = "left"));
            let y = [];
              ...
              t.forEach((t, s) => {
                ...
                i
                  ? (t.width &&
                    ...
                    !r && m(t.fixed)
                      ? ((e._fixed = !0), (t.disableCustomize = !0))
                      : delete t.fixed,
                    !t.disableCustomize || t.width
                      ? ((v[i] = t),
                        ...
                        r &&
                          (C(t.children) && w(t.children, o + 1, t.key),
                          (v[i].pk = n),
                          (v[i].level = o)))
                      : qt(`column ${i}: width must be set`))
                  : qt(`columnData[${s}].key undefined`);
              });
            };
          ...
          Ho = (e) => (t, o, n) => {
            ...
            n.value = (o) => {
              const n = s.call(t, o);
              return ((o && o.tpl) || e).replace(
                /\{\{([^(\}\})]+)\}\}/g,
                (e, t) => new Function("vm", "return " + t)(n) || "",
              );
            };
          },
            ...
            return (
              t
                ? (c &&
                  ...
                  (a || i) && ((u = Eo), l.push({ row: o, index: n, key: s })),
                  c || (d = t(o[s], o, n, s)))
                : ((d = o[s]), (f(d) || g(d)) && (d = "")),
        ...
        async function qo(e) {
          ...
          i.forEach((e, t) => {
            ...
            n && (await n(i), (a = r.querySelectorAll(`${pt(t)} [${Eo}]`))),
            o && (await o(i)),
            s && (await s(i)),
            [].forEach.call(a, (e) => {
        ...
        function Fo(e, t, o, n, s) {
          ...
          if (3 === i && k(arguments[2])) r = arguments[2];
          else if (i > 2) for (let e = 2; e < i; e++) r.push(arguments[e]);
          try {
            let o = Bo(e, t);
            return r && r.length
              ? o.replace(/{\d+}/g, (e) => {
        ...
        const Go = new (class {
            ...
            downStatic(e, t, o, n, s, r, i, a, c, l, d, h) {
              ...
              Io(
                n,
                `data:${{ csv: "text/csv", xls: "application/vnd.ms-excel" }[r]};charset=utf-8,\ufeff${encodeURIComponent(g)}`,
              ),
                !t && ut(e, 300);
            }
          ...
          Vo = (e, t) => {
            u(t, (t, o) => {
              ...
              const s = St(
                xt(e, t),
                yt(e).find("tr:not([gm-summary-row]):not([gm-row-hide])"),
              );
              let r = s.length,
                i = r,
                a = 1;
              for (; i; ) {
                ...
                if (
                  ...
                  return void (a > 1 && (e.attr(Wo, a), (a = 1)));
                s.eq(i - 1)[n]() === e[n]()
                  ? (e.attr(Jo, ""), a++)
                  : a > 1 &&
                    (e.attr(Wo, a), i + a === r && e.attr(Uo, ""), (a = 1));
              }
            });
          },
          Xo = (e) =>
            Q(`[gm-cache-key="${e}"], [${pe}="${e}"], [${pe}^="${e}-"]`),
          Yo = (e, t) => {
            const o = Xo(t);
            o.attr(qe, "ing"),
              setTimeout(() => {
          ...
          tn = (e, t) => {
              ...
              s &&
                u.push(
                  ...
                  ((e) => ({
                    ...
                    run: (e, t) => {
                      0 === Q('tr[checked="true"]', yt(e)).length
                        ? t.addClass(Re)
                        : t.removeClass(Re);
                    },
                  }))(o),
              ...
              l &&
                u.push(
                  ((e) => ({
                    ...
                    run: (e, t, o) => {
                      "td" !== o.nodeName && 0 === Q(o).closest("td").length
                        ? t.addClass(Re)
                        : t.removeClass(Re);
                    },
                  }))(o),
              ...
              d &&
                u.push(
                  ((e) => ({
                    ...
                    run: (e, t, o) => {
                      "tr" !== o.nodeName &&
                      0 === Q(o).closest("tr[gm-cache-key]").length
                        ? t.addClass(Re)
                        : t.removeClass(Re);
                    },
                  }))(o),
            ...
            u.forEach((e, t) => {
              (h += `<span menu-action>${e.content}</span>`),
                e.line &&
                  t !== p - 1 &&
                  (h += '<span class="menu-line"></span>');
            }),
              Q("[grid-master]").remove(),
              Q("body").append(
                `<div class="gm-menu" grid-master="${e}">${h}</div>`,
              );
            const g = Q(Zo(e)),
        ...
        class ln {
          init(e) {
            ...
            Q(t.target).on(t.events, t.selector, function () {
              const e = Q(this),
                t = e.find(".ra-area");
              o.get(0).offsetWidth - (e.offset().left - o.offset().left) >
              t.get(0).offsetWidth + 20
                    ...
                    u(Q(`${pt(e)} .${Ne}`), (e) => {
                      ...
                      u(t, (t, a) => {
                        const c = Q(`${pt(e)} th[th-name="${t}"]`),
                          l = Q(`.${Ne}`, c);
                        a === o &&
                          (l.addClass(s), l.removeClass(r), c.attr(i, o)),
                          a === n &&
                            (l.addClass(r), l.removeClass(s), c.attr(i, n));
                      });
                  })(e),
                    o(t),
                    s.sortingAfter(r);
        ...
        class Dn {
          init(e) {
            ...
            Q(s.target).on(s.events, s.selector, function (s) {
              ...
              h
                .find(".filter-list")
                .css("max-height", mt(e).height() - 70 + Ke),
                u(i, (e) => {
              ...
              const g = "direction-left",
                f = "direction-right";
              c.offset().left + h.width() > ft(e).width()
                ? (h.addClass(f), h.removeClass(g))
                : (h.addClass(g), h.removeClass(f)),
              ...
              Q(l.target).on(l.events, l.selector, function () {
                ...
                u(e, (e) => {
                  Ls(
                    Q(e).find(".gm-radio"),
                    this === e.querySelector(".gm-radio-input"),
                  );
                });
              });
          }
          createHtml(e) {
            ...
            return (
              ...
              o.option.forEach((e) => {
                ...
                o.isMultiple
                  ? (n += `<li class="filter-checkbox">${Ks.getCheckboxTpl(s)}</li>`)
                  : (n += `<li class="filter-radio">${Ks.getRadioTpl(s)}</li>`);
              }),
              {
          ...
          update(e, t) {
            ...
            u(n, (e) => {
              ...
              t.isMultiple
                ? Ns(o, t.selected.split(",").includes(e.value) ? Oe : Pe)
                : Ls(o, e.value === t.selected);
            }),
        ...
        class Mn {
          ...
          getThTpl(e) {
            ...
            let l = "",
              d = "";
            o.remind &&
              ((l = "remind"), (d = dn.createHtml({ remind: o.remind })));
            let u = "",
              h = "";
            m(o.sorting) &&
              (o.sorting === a
                ? ((u = `sorting="${a}"`), (r[o.key] = a))
                : o.sorting === i
                  ? ((u = `sorting="${i}"`), (r[o.key] = i))
                  : (u = "sorting"),
              (h = kn.createHtml({
                type: o.sorting,
                sortUpText: i,
            ...
            x(o.filter) &&
              ((p = "filter"),
              g(o.filter.selected)
                ? (o.filter.selected = n[o.key])
                : (n[o.key] = o.filter.selected),
              (f = jn.createHtml({ settings: t, columnFilter: o.filter })));
            let v = "";
            c && !o.disableCustomize && (v = hr.html);
            let b = "";
            ("left" !== o.fixed && "right" !== o.fixed) ||
              (b = `fixed="${o.fixed}"`);
                ...
                const e = ((e, t, o) => {
                  ...
                  return (
                    o &&
                      ((s || r || i) &&
                        ((l = Eo),
                        a.push({ key: t, template: o, type: "text" })),
                      i || (c = o())),
                    { text: c, compileAttr: l }
                  );
                })(t, C, o.text);
        ...
        class Nn {
                  ...
                  j.on(A, function (e) {
                    ...
                    (D = k.index()),
                      ...
                      (C = ((e, t, o, n, s, r, i, a) => {
                        ...
                        if (
                          (s &&
                            n.offset().top < s.offset().top &&
                            (s.before(i), (l = s)),
                          r &&
                            n.offset().top + n.height() / 2 > r.offset().top &&
                            (r.after(i), (l = r)),
                          l)
                        ) {
                          const e = l.attr(ue);
          ...
          getColumn(e) {
            ...
            return {
              ...
              fixed: t,
              template: () =>
                '<td gm-create gm-moverow><i class="gm-icon gm-icon-move"></i></td>',
            };
          }
          destroy(e) {
            Et(Hn[e]);
          ...
          Fn = (e, t, o, n, s, r, i, a) => {
            ...
            return (
              n && (d = [[Bn, s + ""]]),
              {
                ...
                tdList: [
                  `<td colspan="${t}"><div class="full-column-div" ${l}>${c}</div></td>`,
                ],
              }
            );
          },
              ...
              n.push(
                ((e, t, o = 0) => (
                  b(o) && (o += Ke),
                  {
                    className: [],
                    attribute: [
                      ["full-column-interval", o + ""],
                      [pe, t + ""],
                    ],
                    querySelector: `[full-column-interval][${pe}="${t}"]`,
                    tdList: [
                      `<td colspan="${e}"><div style="height: ${o}"></div></td>`,
                    ],
                  }
                ))(h, o, d),
              );
        ...
        const Wn = new (class {
            init(e) {
              ...
              if ((ft(e).attr("gm-full-column", ""), t)) {
                qn[e] =
                  ((o = `${pt(e)} tbody`), { fold: ct(Qe, o, `i[${Kn}]`) });
                const t = qn[e].fold;
                Q(t.target).on(t.events, t.selector, function () {
                  const t = Q(this),
                    o = t.closest("tr"),
            ...
            getColumn(e) {
              ...
              return {
                ...
                fixed: o,
                template: () =>
                  `<td gm-create gm-fold><i class="gm-icon ${Gn(t)}" ${Kn}="${t}"></i></td>`,
              };
            }
            destroy(e) {
              Et(qn[e]);
              ...
              t[r] || (t[r] = []),
                C(s.children)
                  ? ((s.rowspan = 1),
                    ...
                    os(e, t, s.children, n - 1))
                  : ((s.rowspan = n), (s.colspan = 1)),
                r > 0 && t[r].push(s);
            });
          };
        const ns = new (class {
          ...
          rs = (e, t) => {
            ...
            s.addClass(Te),
              yt(o).html(
                `<tr empty-template="${o}" style="height: ${s.height() - 1 + Ke}"><td colspan="${kt(o).length}"></td></tr>`,
              );
            ...
            (r.innerHTML = ((e, t, o) => {
              const {
                ...
                a = Lo(n);
              return i
                ? (a.push({ el: t, template: o, type: "empty", fnArg: [e] }),
                  "")
                : (r && a.push({ el: t }), s && a.push({ el: t }), o(e));
            })(e, r, n)),
              qo(e);
          },
          is = async (e, t, o, n, s) => {
            ...
            try {
              ...
              if (
                ...
                let e,
                  t,
                  o = ((e, t, o) =>
                    e.querySelector(`[full-column="${t}"][${pe}="${o}"]`))(
                    d,
                    "top",
                    n,
                  );
                ...
                u(d.children, (o, n) => {
                  b(e) || b(t)
                    ? (b(e) && n < e && i.push(o), b(t) && n > t && i.push(o))
                    : i.push(o);
                }),
                  u(i, (e) => e.remove());
              }
        ...
        const us = new (class {
          ...
          async changeTableData(e, t, o, n) {
            ...
            (tr.virtualScrollMap[e] = async (t) => {
              ...
              if ((i.length && (x = i.height()), k && Math.abs(r - k) < x))
                return;
              k = r;
              ...
              const d = c * x;
              p.css({ marginTop: d - m, marginBottom: (y.length - l) * x }),
            ...
            if (p && k(p))
              if (!i || d || u || !isNaN(parseInt(g, 10))) {
                ...
                await this.changeTableData(n, p, !0),
                  ...
                  a && en(n),
                  v(o) && o(h);
              } else qt(`response.${l} undefined，please check totalsKey`);
            else qt(`response.${c} is not Array，please check dataKey`);
          }
          async createDOM(e, t) {
            ...
            c.text(t),
              Q(s.target).on(s.events, s.selector, function (e) {
                ...
                if ("block" === l.css("display"))
                  return l.hide(), void t.unbind(r.events);
                l.show();
                const o = r.events;
                t.unbind(o),
                  t.bind(o, function () {
        ...
        const Cs = (e, t, o) => {
            ...
            Q("[pagination-number]", e).html(
              ((e, t) => {
                ...
                if (
                  (o > 4 &&
                    ((s +=
                      '<li to-page="1">1</li><li class="disabled">...</li>'),
                    (i = o - 2)),
                  n - o > 4 &&
                    ((a = o + 2),
            ...
            const r = o[s],
              ...
              p = Boolean(l.length);
            1 === r
              ? (d && i.addClass(Re), u && a.addClass(Re))
              : (d && i.removeClass(Re), u && a.removeClass(Re)),
              r >= o.tPage
                ? (h && c.addClass(Re), p && l.addClass(Re))
                : (h && c.removeClass(Re), p && l.removeClass(Re));
          },
          $s = (e, t) => {
            (!t || t < 1) && (t = 1);
            const {
            ...
            const {
              ...
              p = (t, n) => {
                const s = ((e, t, o) => {
                  ...
                  let l = 1;
                  return (
                    (l = t ? Math.ceil(t / a) : o < a ? c : c + 1),
                    { tPage: l, [i]: c > l ? 1 : c, [s]: a, tSize: t }
                  );
                })(e, t, o);
                Cs(d, e, s),
                  ((e, t, o, n) => {
          ...
          Hs = (e, t, o, n, s) => {
            ...
            return (
              o &&
                !n &&
                r.forEach((e) => {
                  e.gm_checkbox_disabled ||
                    (e.gm_checkbox !== t && i.push(e), (e.gm_checkbox = t));
                }),
              o || s || !n || ((r[n].gm_checkbox = t), i.push(r[n])),
              s &&
                r.forEach((e) => {
                  e[ue] === n
                    ? ((e.gm_checkbox = !0), i.push(e))
                    : (e.gm_checkbox = !1);
                }),
              xo(e, r),
              ko(e, i, s),
        ...
        const Rs = "disabled-selected",
          ...
          zs = (e, t, o, n) => {
            ...
            if (
              ...
              u(t, (t) => {
                const o = Q(t);
                Q(".gm-checkbox", o).hasClass("gm-checkbox-checked") ||
                  (wo(e).length >= n ? o.addClass(Rs) : o.removeClass(Rs));
              }),
        ...
        class qs {
          init(e) {
            ...
            Ps[e] =
              ((t = pt(e)),
              {
                ...
                checkboxChange: ct(
                  Qe,
                  t,
                  "td[gm-checkbox] .gm-checkbox-wrapper",
                ),
            ...
            Q(o.target).on(o.events, o.selector, function () {
              ...
              Q(s.target).on(s.events, s.selector, function () {
                ...
                if (
                  !1 ===
                  a(wo(e), "true" === t.getAttribute("checked"), bo(e, t))
                )
              ...
              h &&
                Q(r.target).on(r.events, r.selector, function (t) {
                  ...
                  "TD" !== s.nodeName && (r = r.closest("td")),
                    o.gm_checkbox_disabled ||
                      m(r.attr(Rs)) ||
                      n.hasClass(Rs) ||
                      -1 !==
                        [].indexOf.call(
                          s.classList,
                          "gm-radio-checkbox-input",
                        ) ||
                      n.find("input").trigger("click");
                });
          }
          addSign(e) {
          ...
          getColumnTemplate(e) {
            ...
            return {
              template: s
                ? n
                  ? this.getRadioTpl({ checked: t, disabled: o })
          ...
          updateConfigList(e) {
            ...
            u(Oo(e).columnMap, (e, t) => {
              ...
              u(s, (t) => {
                ...
                o.append(this.createColumn({ key: s, isShow: r, label: i })),
                  r && n++;
              });
        ...
        const tr = new (class {
            ...
            destroy(e) {
              ...
              t &&
                t.el &&
                t.observer &&
                (t.observer.unobserve(t.el), delete Zs[e]),
          ...
          sr = (e, t, o, n) =>
            `[${te}="${e}"][gm-overflow-x="true"] tr:not([empty-template]) td:nth-of-type(${t + 1}){position: sticky;\nposition: -webkit-sticky;\n${o}: var(--gm-${e}-${t}-sticky-value);\nz-index: 3;\nbox-shadow: ${n};}`,
          rr = {},
          ir = {},
          ar = {},
          cr = "fixed-focus";
        const lr = new (class {
            init(e) {
              ...
              (rr[t] = p.sort((e, t) => e.index - t.index)),
                u(rr[t], (e, o) => {
                  const n = wt(t, e.key);
                  o === f - 1 &&
                    (m = "2px 0 4px rgba(var(--mdui-color-surface-variant))"),
                    (l += sr(t, e.index, "left", m)),
                    (e.pl = d),
                    (d += e.width),
                    n.css({ height: c, lineHeight: c, boxShadow: m });
                }),
                "safari" === o && d--,
            ...
            update(e) {
              ...
              if (rr[e] && rr[e].length) {
                ...
                u(rr[e], (r) => {
                  (t = c(e, r)),
                    wt(e, r.key).css({ width: t, left: s + n }),
                    nr(e, o, r.index, s),
                    (s += t);
                }),
              ...
              if (ir[e] && ir[e].length) {
                ...
                ir[e].forEach((t) => {
                  (i = c(e, t)),
                    wt(e, t.key).css({ width: i, right: a + s }),
                    nr(e, o, t.index, a),
                    (a += i);
                }),
            ...
            ur[e] = (function (e, t) {
              return {
                start: ct(
                  et,
                  t,
                  `[grid-manager-mock-thead="${e}"] .gm-adjust-action`,
                ),
                doing: ct(tt, `[${te}="${e}"]`, t),
                ...
                ((e, t, o, n, s) => {
                  ...
                  Q(c.target).on(c.events, c.selector, function (c) {
                    ...
                    if (r !== h) {
                      ...
                      s < r && (i = o.width()),
                        l.width(u + r + i),
                        t.css({ width: r, "max-width": r }),
                        o.css({ width: i, "max-width": i }),
                        lr.update(e);
                    }
                  });
                })(
                  ...
                  p,
                  Mt(e, u[$t(o)], d),
                  Math.ceil(t.clientX - o.offset().left),
                ),
                ((e, t, o, n) => {
          ...
          init(e) {
            ...
            mr[e] = ((e, t) => ({
              start: ct(
                et,
                t,
                `[grid-manager-mock-thead="${e}"] .gm-drag-action`,
              ),
            ...
            Q(s.target).on(s.events, s.selector, function (s) {
              ...
              m.append('<div class="gm-dreamland-div"></div>'),
                ...
                (b.get(0).innerHTML = t.createHtml({ $table: o, $th: p }));
              let y = 0;
              const x = p.width(),
                w = p.height(),
                k = o.height(),
              ...
              S.off(r.events),
                S.on(r.events, function (o) {
                  ...
                  b.show(),
                    (y = p.index(f)),
                    y > 0 && ((n = f.eq(y - 1)), (s = $t(n))),
                    y < f.length - 1 && ((r = f.eq(y + 1)), (i = $t(r))),
                    n && n.length && c[s].disableCustomize
                      ? (n = void 0)
                      : r && r.length && c[i].disableCustomize && (r = void 0),
                    b.css({ left: o.clientX + $, top: o.clientY + T }),
            ...
            Q(t.target).on(t.events, function (n) {
              ...
              a.off(c),
                a.on(c, function (t) {
                  const o = Q(t.target);
                  o.attr(se) ||
                    1 === o.closest("[grid-master]").length ||
                    en(e);
                });
            });
          }
        ...
        class Tr {
          constructor(e, t, o) {
            ...
            if ((m(s) ? n.attr(Z, s) : (s = t.gridManagerName = ht(e)), !m(s)))
              return void qt("gridManagerName undefined");
            let r = Tr.get(s);
            if ((r.rendered && Tr.destroy(s), $r[s] && !vo[s])) return;
            if (
              ($r[s] && vo[s] && (clearInterval(vo[s]), delete vo[s]),
              ($r[s] = !0),
              !t || w(t))
            )
            ...
            x(t.fullColumn) &&
              (v(t.fullColumn.topTemplate) || v(t.fullColumn.bottomTemplate)) &&
              ((t.supportConfig = !1),
              (t.supportDrag = !1),
              (t.supportMoveRow = !1),
              (t.supportTreeData = !1),
              ...
              t.supportTreeData &&
                ...
                (t.__isFullColumn = !1),
                delete t.virtualScroll),
              t.columnData.some((e) => C(e.children)) &&
                ((t.supportConfig = !1),
                (t.supportDrag = !1),
                (t.supportAdjust = !1),
                (t.disableLine = !1),
              ...
              (r = Mo(
                t,
                zn.getColumn.bind(zn),
                Ks.getColumn.bind(Ks),
                pr.getColumn.bind(pr),
                Wn.getColumn.bind(Wn),
              )),
              Ve(r._);
            const i = () => {
                g(n.attr(ye)) ||
          ...
          static resetLayout(e, t, o) {
            const n = ht(e),
              s = Oo(n);
            kr(n, s) &&
              ((s.width = t), (s.height = o), _o(s), Ht(s), tr.update(n));
          }
          static clear(e) {
            const t = ht(e);
            return kr(t) && So(t);
          ...
          static setAjaxData(e, t, o) {
            const n = ht(e),
              s = Oo(n);
            kr(n, s) &&
              (S(s, { ajaxData: t }), xo(n, []), _o(s), us.refresh(n, o));
          }
          static refreshGrid(e, t, o) {
            ...
            kr(n, s) &&
              (y(t) || ((o = t), (t = !1)),
              t && ((s.pageData[s.currentPageKey] = 1), _o(s)),
              us.refresh(n, o));
          }
            ...
            if (kr(n, s)) {
              ...
              return (
                ...
                r &&
                  ((e, t, o, n) => {
                    uo.checkedData[e] &&
                      (uo.checkedData[e] = uo.checkedData[e].map(
                        (e) => (
                          n.forEach((n) => {
                            e[o] === n[o] && S(e, lt(t, n));
                          }),
        ...
        (Element.prototype.GM = Element.prototype.GridManager =
          function () {
            let e, t, o, n;
            const s = arguments;
            if (
              (m(s[0])
                ? ((e = s[0]), (t = s[1]), (o = s[2]), (n = s[3]))
                : ((e = "init"), (t = s[0]), (o = s[1])),
              "init" !== e)
            )
